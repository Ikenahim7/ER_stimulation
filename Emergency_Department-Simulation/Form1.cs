...
namespace Emergency_Department_Simulation
{
    public partial class Form1 : Form
    {
        ...
        {
            counter++;
            if (cbContinuousPatients.Checked && counter % (Convert.ToInt32(tbSecondsPerPatient.Text) * 100) == 0)
                sim.AddPatients(1);
        ...
        private void startStopButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                sim.RandomPatients = addPatientsRndCheckBox.Checked;
            }
        ...
        private void warningTimer_Tick(object sender, EventArgs e)
        {
            ...
            if(nr == 1)
            {
                warningLabel.Text = nr + " patient is in critical state!";
            }
            else if(nr > 1)
            {
        ...
        private void addPatientsRndCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            if(sim.Running)
            {
                sim.RandomPatients = addPatientsRndCheckBox.Checked;
